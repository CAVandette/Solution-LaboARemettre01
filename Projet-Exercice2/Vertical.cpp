...
*/
	...
	// WOW : Magnifique de laisser la trace de tous tes raisonnements. Je peux ainsi voir le temps et la ténacité avec laquelle tu as résolu le problème !!!


//solution finale: 5em solution (fonctionnel)
// FR : modulo était bel et bien la solution! seulement, il fallait y ajouter de la division, FR : c'était si simple que le voile de complexité me bloquais la vue!!!
...
// KM : C'est drôle que le nom de variables ne suit pas la logique du commentaire !!!!
...
/*À qui de droit, de numéro 5 à 1 suivant, il fût plus que difficile de résoudre la solution. Tel que laissé sous forme de commentaires, FR :  tout mes croquis montre bien la démarche
étape par étape de mon raisonnement vers cette solution finale (et surtout fonctionnelle). il me fallut 7h51 minutes FR : environs pour mettre a terme ce projet. bien qu'il s'agit d'une 
quantité d'heures FR : irrationnel pour cette charge de travail, FR : avoir remplis ma commande me suffit a rembourser la quantité d'efforts donnés. 
Quoi qu'il en soit, FR : la fierté éprouvé l'orsque je cria "Eureka" est indéniable.  */

// KM : WOW, tu apportes le côté humain à ce programme en libérant ici toutes les émotions d'un programmeur tenace et fier d'avoir obtenu enfin le résultat tant cherché !!!
...
// KM : En plus du résultat obtenu, tes explications sont très claires et bien illustrées avec des exemples !!!

// KM : Ce test n'est pas suffisant pour dire que le nombre à exactement 5 chiffres
